...
feature — e.g. `tests/…/Features/Weather/GetForecastHandlerTests.cs`. Discovery/registration
is covered by `tests/…/DependencyInjection/` (`DependencyInjectionExtensionsTests`,
`ReflectionRegistrationTests`).
